# -*- coding: utf-8 -*-
#
# pytest-apireport documentation build configuration file, created by
...
project = u'pytest-apireport'
copyright = u'2015, Pavel Pribyl'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-apireport Documentation',
     [author], 1)
]
